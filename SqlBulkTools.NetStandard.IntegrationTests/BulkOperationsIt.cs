...
//                        Assert.Equal(126, (byte)reader["TinyIntTest"], "Testing TinyIntTest");
...
//                        CollectionAssert.Equal(new byte[] { 3, 3, 32, 4 }, (byte[])reader["ImageTest"], "ImageTest");
//                        CollectionAssert.Equal(new byte[] { 0, 3, 3, 2, 4, 3 }, (byte[])reader["BinaryTest"], "Testing BinaryTest");
//                        CollectionAssert.Equal(new byte[] { 3, 23, 33, 243 }, (byte[])reader["VarBinaryTest"], "Testing VarBinaryTest");
